package com.chivumarius.imageclassificationquantization;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String mModelPath = "mobilenet_v1_0.5_224_quant.tflite";
    private String mLabelPath = "mobilenet_v1_1.0_224.txt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            classifier = new Classifier(getAssets(), mModelPath, mLabelPath, mInputSize,true);
        } catch (IOException e) {
            e.printStackTrace();
        }
